...
#    Updated: 2022/06/30 06:24:04 by vahemere         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = main.c \
manage_cmd.c first_check.c tokenizer.c is_type.c syntax_check.c expand.c split_word.c sign.c delete_quote.c len_expand.c new_node.c \
