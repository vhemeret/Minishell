...
#    Updated: 2022/07/10 20:45:02 by brhajji-         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
cleaning.c  exec_utils.c execve.c init_exec.c ft_itoa.c here_doc.c ft_strcmp.c manage_export.c env.c pwd.c cd.c manage_built_in.c export.c unset.c ft_strcpy.c\
